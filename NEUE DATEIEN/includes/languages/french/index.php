...
* @version $Id: index.php 2024-05-12 15:05:14Z webchills $
*/


define('TEXT_GREETING_GUEST', 'Bienvenue <span class = "greetUser"> visiteur! </ span> Souhaitez-vous  <a href="%s"> vous inscrire</a>?');

define('TEXT_GREETING_GUEST_SHOWCASE', 'Bienvenue sur notre site Internet ! Profitez de notre salle d\'exposition.');
...
define('HEADING_TITLE_PRODUCTS' , 'Produits disponibles');

define('HEADING_TITLE', 'Bienvenue dans notre boutique en ligne!');

define('HEADING_TITLE_NESTED', 'Bienvenue dans notre boutique en ligne!');

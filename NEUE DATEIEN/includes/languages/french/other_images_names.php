...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Supprimer la notification d\'article.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Me prévenir des mises à jour de cet article.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Ecrire un commentaire pour cet article.');

define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Notre boutique en ligne est actuellement fermée en raison de travaux de maintenance. Revenez nous voir plus tard, s\'il vous plaît.');

define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'Vérification en cours...');
